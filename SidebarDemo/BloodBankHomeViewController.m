...
#import "BloodBankHomeViewController.h"
#import "BloodBankMapViewController.h"
#import "SWRevealViewController.h"
#import "DBManager.h"
#import <GoogleMaps/GoogleMaps.h>
@interface BloodBankHomeViewController ()
@property (nonatomic, strong) DBManager *dbManager;

@property (nonatomic, strong) NSArray *arrqueryresult;
@end
CLLocation *currentLocation1;
NSString *administrativeArea1;
CLLocation *closestLocation1;
@implementation BloodBankHomeViewController
...
- (void)locationManager:(CLLocationManager *)manager didUpdateToLocation:(CLLocation *)newLocation fromLocation:(CLLocation *)oldLocation
{
    ...
    if (currentLocation1 != nil) {
        ...
        //NSLog(@"%@",[NSString stringWithFormat:@"%.8f", currentLocation1.coordinate.latitude]);
        //NSLog(@"%@",[NSString stringWithFormat:@"%.8f", currentLocation1.coordinate.longitude]);
    }
}
/*
