//
//  HospitalIndiaCityAllTableViewController.m
//  DrugFinder
//
...
@interface HospitalIndiaCityAllTableViewController ()
@property (nonatomic, strong) DBManager *dbManager;

@property (nonatomic, strong) NSArray *arrqueryresult;
@end

@implementation HospitalIndiaCityAllTableViewController
...
-(void)loadData{
    ...
    NSString *query =[NSString stringWithFormat:@"select * from hospital where District='%@'",self.city] ;
