//
//  DoctorBySpecilityTableViewController.m
//  DrugFinder
//
...
#import "DoctorBySpecilityTableViewController.h"
#import "DBManager.h"
#import "AllDoctorBySpecilityTableViewController.h"
@interface DoctorBySpecilityTableViewController ()
@property (nonatomic, strong) DBManager *dbManager;

@property (nonatomic, strong) NSArray *arrqueryresult;
@end

@implementation DoctorBySpecilityTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"Specialty";
...
-(void)loadData{
    ...
    NSString *query =[NSString stringWithFormat:@"select (Physician_Specialty) from list where Physician_Primary_Type='%@'",self.type] ;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSInteger indexOfType = [self.dbManager.arrColumnNames indexOfObject:@"Physician_Specialty"];
   ...
   // UILabel *textfield = (UILabel *)[cell viewWithTag:10];
    cell.textLabel.text = [NSString stringWithFormat:@"%@", [[self.arrqueryresult objectAtIndex:indexPath.row] objectAtIndex:indexOfType]];
    
    //textfield.text = [NSString stringWithFormat:@"%@", [[self.arrqueryresult objectAtIndex:indexPath.row] objectAtIndex:indexOfType]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    AllDoctorBySpecilityTableViewController *dfd = [self.storyboard instantiateViewControllerWithIdentifier:@"allspecilitylist"];
