...
#import "HospitalIndiaStateTableViewController.h"
#import "DBManager.h"
#import "HospitalIndiaCityTableViewController.h"
@interface HospitalIndiaStateTableViewController ()
...
@implementation HospitalIndiaStateTableViewController
...
-(void)loadData{
    ...
    NSString *query =[NSString stringWithFormat:@"select (State) from hospital"] ;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HospitalIndiaCityTableViewController *dfd = [self.storyboard instantiateViewControllerWithIdentifier:@"HospitalIndiacity"];
