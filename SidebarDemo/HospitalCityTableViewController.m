//
//  HospitalCityTableViewController.m
//  DrugFinder
//
...
#import "HospitalCityTableViewController.h"
#import "HospitalZipCodeTableViewController.h"
#import "DBManager.h"
@interface HospitalCityTableViewController ()
@property (nonatomic, strong) DBManager *dbManager;

@property (nonatomic, strong) NSArray *arrqueryresult;
@end

@implementation HospitalCityTableViewController
...
-(void)loadData{
    ...
    NSString *query =[NSString stringWithFormat:@"select (City) from General_Information where State='%@'",self.State] ;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HospitalZipCodeTableViewController *dfd = [self.storyboard instantiateViewControllerWithIdentifier:@"hospitalzipcode"];
