//
//  HospitalNamesTableViewController.m
//  DrugFinder
//
...
#import "DBManager.h"
@interface HospitalNamesTableViewController ()
@property (nonatomic, strong) DBManager *dbManager;

@property (nonatomic, strong) NSArray *arrqueryresult;
@end

@implementation HospitalNamesTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"Hospital Names";
...
-(void)loadData{
    ...
    NSString *query =[NSString stringWithFormat:@"select * from General_Information where ZIPCode='%@'",self.zipcode] ;
