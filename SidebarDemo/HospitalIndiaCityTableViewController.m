//
//  BloodBankCityTableViewController.m
//  DrugFinder
//
...
#import "HospitalIndiaCityTableViewController.h"

#import "DBManager.h"
#import "HospitalIndiaCityAllTableViewController.h"
@interface HospitalIndiaCityTableViewController ()
@property (nonatomic, strong) DBManager *dbManager;

@property (nonatomic, strong) NSArray *arrqueryresult;
@end

@implementation HospitalIndiaCityTableViewController
...
-(void)loadData{
    ...
    NSString *query =[NSString stringWithFormat:@"select (District) from hospital where State='%@'",self.state] ;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSInteger indexOfState = [self.dbManager.arrColumnNames indexOfObject:@"District"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HospitalIndiaCityAllTableViewController *dfd = [self.storyboard instantiateViewControllerWithIdentifier:@"HospitalIndiacityall"];
    //dfd.Country = self.country;
    dfd.city = [[self.arrqueryresult objectAtIndex:indexPath.row] objectAtIndex:indexOfState];
