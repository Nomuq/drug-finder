//
//  HospitalStateTableViewController.m
//  DrugFinder
//
...
#import "HospitalStateTableViewController.h"
#import "HospitalCityTableViewController.h"
#import "DBManager.h"
@interface HospitalStateTableViewController ()
@property (nonatomic, strong) DBManager *dbManager;

@property (nonatomic, strong) NSArray *arrqueryresult;
@end

@implementation HospitalStateTableViewController
...
-(void)loadData{
    ...
    NSString *query =[NSString stringWithFormat:@"select (State) from General_Information"] ;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HospitalCityTableViewController *dfd = [self.storyboard instantiateViewControllerWithIdentifier:@"hospitalcity"];
