//
//  DoctorByTypeTableViewController.m
//  DrugFinder
//
...
#import "DoctorByTypeTableViewController.h"
#import "DBManager.h"
#import "DoctorBySpecilityTableViewController.h"
@interface DoctorByTypeTableViewController ()
@property (nonatomic, strong) DBManager *dbManager;

@property (nonatomic, strong) NSArray *arrqueryresult;
@end

@implementation DoctorByTypeTableViewController
...
-(void)loadData{
    ...
    NSString *query =[NSString stringWithFormat:@"select (Physician_Primary_Type) from list"] ;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    DoctorBySpecilityTableViewController *dfd = [self.storyboard instantiateViewControllerWithIdentifier:@"byspecility"];
