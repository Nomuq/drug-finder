...
@interface BloodBankCityTableViewController ()
@property (nonatomic, strong) DBManager *dbManager;

@property (nonatomic, strong) NSArray *arrqueryresult;
@end

@implementation BloodBankCityTableViewController
...
-(void)loadData{
    ...
    NSString *query =[NSString stringWithFormat:@"select (city) from bloodbank where state='%@'",self.state] ;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BloodBankCityAllTableViewController *dfd = [self.storyboard instantiateViewControllerWithIdentifier:@"bloodbankcityall"];
