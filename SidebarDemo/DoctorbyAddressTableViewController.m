//
//  DoctorbyAddressTableViewController.m
//  DrugFinder
//
...
@interface DoctorbyAddressTableViewController ()
@property (nonatomic, strong) DBManager *dbManager;

@property (nonatomic, strong) NSArray *arrqueryresult;
@end

@implementation DoctorbyAddressTableViewController
...
-(void)loadData{
    ...
    NSString *query =[NSString stringWithFormat:@"select * from list where Recipient_Zip_Code='%@'",self.Zipcode] ;
