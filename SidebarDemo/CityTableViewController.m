...
-(void)loadData{
    ...
    NSString *query =[NSString stringWithFormat:@"select (Recipient_City) from list where Recipient_Country='%@' and  Recipient_State='%@'",self.Country,self.State] ;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ZipcodeTableViewController *dfd = [self.storyboard instantiateViewControllerWithIdentifier:@"zipcodetable"];
