//
//  HospitalZipCodeTableViewController.m
//  DrugFinder
//
...
#import "HospitalZipCodeTableViewController.h"
#import "HospitalNamesTableViewController.h"
#import "DBManager.h"
@interface HospitalZipCodeTableViewController ()
@property (nonatomic, strong) DBManager *dbManager;

@property (nonatomic, strong) NSArray *arrqueryresult;
@end

@implementation HospitalZipCodeTableViewController
...
-(void)loadData{
    ...
    NSString *query =[NSString stringWithFormat:@"select (ZIPCode) from General_Information where City='%@'",self.City] ;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSInteger indexOfState = [self.dbManager.arrColumnNames indexOfObject:@"ZIPCode"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HospitalNamesTableViewController *dfd = [self.storyboard instantiateViewControllerWithIdentifier:@"hospitalname"];
    //dfd.Country = self.country;
    dfd.zipcode = [[self.arrqueryresult objectAtIndex:indexPath.row] objectAtIndex:indexOfState];
